...
import { analyzeBasketFlow, askFlow, chatFlow, configFlow, creditsFlow, feedbackFlow, historyFlow, messageFlow, sessionFlow, stateFlow, tagsFlow, tagsVocabularyFlow, updateConfigFlow, updateTagsVocabularyFlow, usageFlow } from "./controllers/assistantController.js";
...
app.get("/api/config", configFlow);
app.put("/api/config", updateConfigFlow);
app.get("/api/credits", creditsFlow);
app.get("/api/tags", tagsFlow);
app.get("/api/tags/vocabulary", tagsVocabularyFlow);
app.put("/api/tags/vocabulary", updateTagsVocabularyFlow);
